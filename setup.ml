...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4bc867b4610691b1d5691ed2819d2b5a) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          license_file = None;
          copyrights = ["(C) 2014 Citrix Systems"];
          maintainers = [];
          authors = ["John Else"];
          homepage = None;
          synopsis = "Demo RRDD plugin";
          description = None;
          categories = [];
            ...
            [
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("rrdd-plugin", None)
                        ];
                   ...
                   {exec_custom = false; exec_main_is = "demo_plugin.ml"})
            ];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some ")\217\156\210L\244\201\155h\166\222^\154d[\193";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
